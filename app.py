...
def main():
    ...
    with st.expander("**How to use each tool**"):
        st.markdown("""
    ...
    with col1:
        user_query = st.text_input("Search over ideas from the lectures:", placeholder="eg, hemispheric differences, Tower of Babel, etc.")
    with col2:
